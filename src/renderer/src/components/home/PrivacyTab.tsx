...
export const PrivacyTab: React.FC = () => {
  return (
    <div className="space-y-6 animate-fade-in pb-20">
      {/* Header Banner */}
      <div
        className="card-surface rounded-2xl p-6 relative overflow-hidden cursor-target transition-colors duration-200"
        style={{
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-xs" style={{ color: 'var(--menu-text-muted)' }}>
              Strictly local data handling with zero telemetry
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
        <div
          className="card-surface rounded-2xl p-5 space-y-3 cursor-target hover:border-[#C44900]/50 transition-colors"
          style={{
            backgroundColor: 'var(--menu-surface)',
            border: '1px solid var(--menu-card-border)'
          }}
        >
          ...
          <p style={{ color: 'var(--menu-text-secondary)' }} className="leading-relaxed">
            Your calendar events and preferences are parsed, computed, and saved entirely on your local machine in <code className="px-1.5 py-0.5 rounded font-mono text-[11px]" style={{ backgroundColor: 'var(--menu-input-bg)' }}>%APPDATA%/Calendar Widget/config.json</code>.
          </p>
        ...
        >
          ...
          <p style={{ color: 'var(--menu-text-secondary)' }} className="leading-relaxed">
            When polling calendar feeds, standard HTTPS requests are made directly from your PC to Google’s iCal endpoints (<code className="px-1.5 py-0.5 rounded font-mono text-[11px]" style={{ backgroundColor: 'var(--menu-input-bg)' }}>calendar.google.com</code>) using TLS encryption and ETag caching.
          </p>
        </div>
